        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Upload retinal fundus images and get instant AI-powered analysis including vessel mapping, 
              diabetic retinopathy detection, and glaucoma screening with advanced deep learning models.
            </p>
